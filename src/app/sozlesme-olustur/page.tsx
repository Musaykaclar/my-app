        ...
        <div className="w-full max-w-5xl mx-auto mt-10 p-10 bg-white rounded-2xl shadow-2xl border border-gray-200 z-10">
          ...
          {showPopup && (
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              <div ref={popupRef} className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-8 max-w-md w-full flex flex-col items-center animate-fadeIn">
                <h2 className="text-2xl font-bold text-[#fb7185] mb-6">Nasıl Sözleşme Oluşturmak İstersiniz?</h2>
                <div className="flex flex-col gap-4 w-full">
                  <button
                    ...
                    onClick={() => { setShowPopup(false); alert('Chatbot ile sözleşme oluşturma yakında!'); }}
                  >
                    🤖 Chatbot ile
                  </button>
                  <button
                  ...
                  <button
                    ...
                    onClick={() => { setShowPopup(false); alert('Speech to Text ile sözleşme oluşturma yakında!'); }}
                  >
                    🎤 Speech to Text ile
                  </button>
                </div>
          ...
          {showForm && (
            <>
              ...
              >
                <option value="">Bir sözleşme türü seçin</option>
