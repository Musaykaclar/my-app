...
export default function HomePage() {
  ...
  <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md z-20">
    <h2 className="text-xl font-bold text-center mb-4 tracking-widest">{t('heroBox.heading')}</h2>
    <div className="h-2 w-16 bg-[#fb7185] rounded-full mx-auto mb-4" />
    <div className="text-gray-400 text-sm mb-2">{t('heroBox.article1')}</div>
    <div className="h-3 bg-gray-100 rounded mb-2" />
    <div className="h-3 bg-gray-100 rounded mb-2 w-2/3" />
    <div className="text-gray-400 text-sm mb-2 mt-4">{t('heroBox.article2')}</div>
    <div className="h-3 bg-gray-100 rounded mb-2" />
    ...
    <div className="mt-6 flex flex-col gap-2">
      ...
      <div className="mt-2 bg-yellow-100 border border-yellow-300 rounded px-3 py-2 flex items-center gap-2">
        <span className="text-gray-600 text-xs">{t('heroBox.by')}:</span>
        <span className="italic text-gray-700 text-xs">{t('heroBox.clickToSign')}</span>
      </div>
    </div>
  </div>
</div>
